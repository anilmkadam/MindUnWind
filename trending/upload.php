...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/trending/assets/images/profile_pics';
	//Set File name
...
***********************************************************/		
		...
		//create new image using correct php func			
			...
			}elseif($_FILES["image"]["type"] == "image/jpg" || $_FILES["image"]["type"] == "image/jpeg" || $_FILES["image"]["type"] == "image/pjpeg"){
