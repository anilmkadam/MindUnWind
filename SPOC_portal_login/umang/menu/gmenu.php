...
<li class="">
                            <a href="#"><i class="fa fa-file-photo-o fa-fw"></i>Club Service<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li><?php if(isset($_SESSION['uname'])){?>
                                    <a class="active" href="addcs.php">Add Club Service</a><?php }?></li>
                                <li>
                                  <?php if(isset($_SESSION['uname'])){?>  <a href="viewcs.php">View Club Services</a><?php }?>                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
