...
<?php
  ...
  $sql="INSERT INTO account(`id`, `fname`, `mname`, `lname`, `email`, `phone`, `dob`, `age`, `gender`, `clgname`, `clgcode`, `std`, `clgaddr`, `prntcontact`,`prntemail`, `resaddr`) VALUES ('','".$fname."','".$mname."','".$lname."','".$email."','".$phone."','".$dob."','".$age."','".$gender."','".$clgname."','".$clgcode."','".$std."','".$addr."','".$contact."','".$prntemail."','".$resaddr."')";
